export const PRODUCTS = [{
    id:"p1",
    name:"Swirl Earrings",
    description: "Twirly whirly swirls.",
    price: 62,
    category: "earrings",
    slug:"swirl-earrings",
    images: [{
...
},
{
    id: "p2",
    name: "Discs Bracelet",
    description: "Handcrafted glass bead bracelet.",
    price: 200,
    category: "bracelets",
    slug: "discs-bracelet",
    images: [{
...
},
{
    id: "p3",
    name: "Discs Necklace",
    description: "Necklace of graduated discs",
    price: 200,
    category: "necklaces",
    slug: "discs-necklace",
    images: [{
...
},
{
    id: "p4",
    name: "Sea Necklace",
    description: "Glass beads and seashells",
    price: 400,
    category: "necklaces",
    slug: "sea-necklace",
    images: [{
...
},
{
    id: "p5",
    name: "Fox Terrier",
    description: "Cute pup face on felt & doggie hair",
    price: 175,
